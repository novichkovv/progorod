...
<div style="text-align: center;color: #245269;">
    <img src="' . SITE_DIR . 'images/5percent.jpg" style="width: 600px;margin-top: 30px;" />
...
<div style="text-align: center;">
    ...
    <a href="' . SITE_DIR . 'home.php?day=0&uid=' . $user['ID'] . '&hash=' . md5(strtolower($user['user_email'])) .'" target="_blank">
        <img src="' . SITE_DIR . 'images/video2.jpg" style="width: 460px;" />
    </a>
</div>
';
$mail .= '
...
<a href="http://1000lbschallenge.com/">http://http://1000lbschallenge.com/</a><br><br>';
if($content['password'])
{
