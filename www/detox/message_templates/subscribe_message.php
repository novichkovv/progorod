...
<div style="min-height: 900px;">
    ...
    <div style="text-align: center;">
        ...
        <a href="' . SITE_DIR . 'home.php?day=0&uid=' . $user_id . '&hash=' . md5(strtolower($_POST['email'])) .'" target="_blank">
            <img src="' . SITE_DIR . 'mail/video.png" style="width: 460px;" />
        </a>
        <br><br>
         <div style="clear: both">
            <a href="' . SITE_DIR . 'home.php?day=0&uid=' . $user_id . '&hash=' . md5(strtolower($_POST['email'])) .'">Click here if the email is not displayed correctly</a>
        </div>
    ';
